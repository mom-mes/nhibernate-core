	...
	public static partial class SerializationHelper
	{
		...
		private sealed class TypeReference : IObjectReference, ISerializable
		{
			...
			public object GetRealObject(StreamingContext context) =>
				Assembly.Load(_assemblyName.FixPlatformTypeName()).GetType(_fullName, true);
		}
		...
		{
			private static readonly bool SystemTypeIsNotSerializable = true;//!typeof(System.Type).IsSerializable;
			private static readonly bool MemberInfoIsNotSerializable = true;//!typeof(MemberInfo).IsSerializable;
			private static readonly bool DelegateIsNotSerializable = true;//!GetDelegateIsSerializable();
